...
import edu.mda.bcb.gdc.api.data.Biospecimen;
 ...
 * @author Tod-Casasent
 */
public class Biospecimens extends Endpoint_Mixin
{
	protected Biospecimen mBiospecimen = null;
	
	public Biospecimens(Biospecimen theBiospecimen)
	{
		super(false);
		mBiospecimen = theBiospecimen;
	}
