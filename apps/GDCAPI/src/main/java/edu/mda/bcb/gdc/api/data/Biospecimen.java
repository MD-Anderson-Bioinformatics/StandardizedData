 ...
 * @author Tod-Casasent
 */
public class Biospecimen extends Fileable implements Comparable<Biospecimen>
{
	public String mProgram = null;
	public String mProject = null;
	
	public Biospecimen(String theProgram, String theProject)
	{
		mProgram = theProgram;
		mProject = theProject;
	...
	@Override
	public int compareTo(Biospecimen o)
	{
	...
	{
		return "biospecimen-manifest".toUpperCase() + "{" + "mProgram=" + mProgram + ", mProject=" + mProject + '}';
	}
	...
	public String loadManifestInternal(File theDir) throws Exception
	{
		...
		if (null!=newestTsv)
		{
			...
			try(BufferedReader br = new BufferedReader(new FileReader(newestTsv)))
			{
				...
				{
					// line should start with "biospecimen" or be "-FileStart-"
