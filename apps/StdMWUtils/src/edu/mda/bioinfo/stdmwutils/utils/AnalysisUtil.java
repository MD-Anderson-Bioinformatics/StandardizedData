...
import edu.mda.bioinfo.stdmwutils.DataMap;
...
public class AnalysisUtil
{
	...
	//private String makeKey(String theStudyHash, String theHash)
	//{
	//	return theStudyHash + "--" + theHash;
	//}
	
	public Analysis getAnalysis(String theStudyHash, String theHash)
	{
		//return mDataMap.get(makeKey(theStudyHash, theHash));
