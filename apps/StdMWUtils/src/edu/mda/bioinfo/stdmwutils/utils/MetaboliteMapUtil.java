...
import edu.mda.bioinfo.stdmwutils.mwdata.RefMet;
import edu.mda.bioinfo.stdmwutils.mwdata.OtherId;
		...
		if (null!=mblts)
		{
			...
			for (Metabolite mtb : mblts)
			{
				...
				else
				{
					...
					{
						theOut.write("\t".getBytes());
						theOut.write(otherid.regno.getBytes());
						theOut.write("\t".getBytes());
						theOut.write(otherid.sys_name.getBytes());
						theOut.write("\t".getBytes());
						theOut.write(otherid.lm_id.getBytes());
						theOut.write("\t".getBytes());
						theOut.write(otherid.hmdb_id.getBytes());
						theOut.write("\t".getBytes());
						theOut.write(otherid.kegg_id.getBytes());
						theOut.write("\t".getBytes());
						theOut.write(otherid.chebi_id.getBytes());
						theOut.write("\t".getBytes());
						theOut.write(otherid.metacyc_id.getBytes());
						theOut.write("\t".getBytes());
						theOut.write(otherid.smiles.getBytes());
						theOut.write("\t".getBytes());
						theOut.write(otherid.name.getBytes());
					}
					theOut.write("\n".getBytes());
				}
			}
