...
public class Analysis implements Comparable<Analysis>
{
	...
	static public Analysis getFromRowString(ArrayList<String> theHeaders, String theRowString)
	{
		Analysis analysis = new Analysis();
		String [] splitted = theRowString.split("\t", -1);
		analysis.hash = splitted[theHeaders.indexOf("hash")];
		analysis.study_hash = splitted[theHeaders.indexOf("study_hash")];
		analysis.study_id = splitted[theHeaders.indexOf("study_id")];
		analysis.analysis_id = splitted[theHeaders.indexOf("analysis_id")];
		analysis.analysis_summary = splitted[theHeaders.indexOf("analysis_summary")];
		analysis.analysis_type = splitted[theHeaders.indexOf("analysis_type")];
		analysis.instrument_name = splitted[theHeaders.indexOf("instrument_name")];
		analysis.instrument_type = splitted[theHeaders.indexOf("instrument_type")];
		analysis.ms_type = splitted[theHeaders.indexOf("ms_type")];
		analysis.ion_mode = splitted[theHeaders.indexOf("ion_mode")];
		return analysis;
	}
