...
public class DataIndex
{
	...
	synchronized public boolean hasEntry(File theZip) throws IOException, Exception
	{
		boolean found = false;
		if (mIndexFile.exists())
		{
		...
		for (DataArchive myRow : mData)
		{
			if ( (false==found) && (myRow.mPath.equals(theZip.getAbsolutePath())) )
			{
				found = true;
			}
		}
