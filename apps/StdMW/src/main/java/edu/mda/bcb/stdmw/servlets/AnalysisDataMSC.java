 ...
 * @author Tod-Casasent
 */
@WebServlet(name = "admsc", urlPatterns =
{
	"/admsc"
})
public class AnalysisDataMSC extends HttpServlet
{
			...
			throws ServletException, IOException
	{
		try
		{
			...
			if (null!=analysis)
			{
				...
				response.setHeader("Content-Disposition", "attachment; filename=\"" + analysis.analysis_id + "_matrix_msc.tsv\"");
				try (OutputStream out = response.getOutputStream())
				{
					if (null==DatatableUtil.getDatatableMSC(out, analysis.analysis_id))
					{
