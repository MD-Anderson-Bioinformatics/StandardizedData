...
import edu.mda.bioinfo.stdmwutils.utils.MwTableUtil;
 ...
 * @author Tod-Casasent
 */
@WebServlet(name = "adata", urlPatterns =
{
	"/adata"
})
public class AnalysisTableData extends HttpServlet
{
